...
Pod::Spec.new do |s|
  ...
  s.version  = "6.0.0"
  s.summary  = "The open source JsonCpp library (Up to date with version 1.9.5). Keeps the project header include folder structure and is updated for deployment targets."
